...
class SubnetAPI {
  ...
  */
  ...
  // headers: list of RLP encoded bytes of subnet headers.
  async submitHeaderInBytes(headers) {
    let transaction = this.subnetContract.methods.receiveHeader(headers);
    const receipt = await this.send(transaction);
    return receipt;
  }
  ...
  async getBlockByNumber(height) {
    let block = await this.subnetContract.methods.getBlockByNumber(height);
    return block[0];
  }
...
if (require.main === module) {
  (async() => {
    ...
    let headerReader = new subnet.web3.eth.Contract(JSON.parse(fs.readFileSync("../build/contracts/HeaderReader.json"))["abi"])
    // console.log(headerReader.deploy({
    //   data: JSON.parse(fs.readFileSync("../build/contracts/HeaderReader.json"))["bytecode"]
    // }).encodeABI());
    console.log(JSON.parse(fs.readFileSync("../build/contracts/HeaderReader.json"))["bytecode"])


    // console.log(subnet.subnetContract.deploy({
    //   data: JSON.parse(fs.readFileSync("../build/contracts/Subnet.json"))["bytecode"],
    //   arguments: [[
    ...
    //   ], 2, "", 
    //   ""]
    // }).encodeABI());
