...
if (require.main === module) {
  (async() => {
    const subnet = new SubnetAPI(
      "http://18.234.173.97:8545",
      fs.readFileSync("../.env", "utf-8").trim(),
      "0x3EdA83Aa86667d076DcDD01050671998331B3Da4",
    ...
    let data = "";
