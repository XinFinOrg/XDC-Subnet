...
Subnet = w3.eth.contract(abi=subnet_contract["abi"], bytecode=subnet_contract["bytecode"].replace("__HeaderReader__________________________", libAddress[2:]))
txn2 = Subnet.constructor(init["validators"], init["threshold"], init["genesis_header_encoded"]).build_transaction({
  "from": account.address,
  "gas": 3400000,
  "gasPrice": 250000000,
  "nonce": w3.eth.get_transaction_count(account.address),
