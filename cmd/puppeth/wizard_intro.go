...
/*
Genesis generation by file input can be done using 'puppeth --file <file_path>' command.
...
Below are all the available configs and their defaults. Code is in GenesisInput struct.
---
name: subnet
period: 2
reward: 2
